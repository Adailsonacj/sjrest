...
public class RestUser {
    ...
    public String getCarroHTML(@QueryParam("id") int id) throws SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException {
        Connect connect = new Connect();
        Carro carro = connect.getUser(id);
        connect.closeConnection();
        return "<HTML><BODY>" + carro.getModelo() + "</BODY></HTML>";
    }
